...
--]]
    ...
    awful.key({ modkey, modkey2, }, "m", function() 
        awful.spawn.with_shell("xrandr --output eDP-1-1 --mode 1920x1080 --refresh 144 --rotate normal --output DP-0 --primary --mode 1920x1080 --refresh 144 --rotate normal --left-of eDP-1-1") 
        end),
    -- single monitor:
