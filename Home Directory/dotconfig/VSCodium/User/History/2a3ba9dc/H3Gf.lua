...
awful.spawn.with_shell("pkill nitrogen; nitrogen --set-zoom-fill ~/Pictures/Wallpapers/blue.jpg --head=0 &; nitrogen --set-zoom-fill ~/Pictures/Wallpapers/blue.jpg --head=1;")
