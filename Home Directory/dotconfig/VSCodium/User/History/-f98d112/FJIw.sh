...
function ActivateDualMode {
    ...
    MONITOR=HDMI-1
    nitrogen --set-zoom-fill ~/Pictures/Wallpapers/blue.jpg --head=0 && nitrogen --set-zoom-fill ~/Pictures/Wallpapers/blue.jpg --head=1 
    }
function DeactivateHDMI {
    echo "Switching to eDP-1"
    xrandr --output HDMI-1 --off --output eDP-1 --auto
    MONITOR=eDP-1
    nitrogen --set-zoom-fill ~/Pictures/Wallpapers/blue.jpg --head=0
}
